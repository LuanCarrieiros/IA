...
O projeto está contido no notebook **[Lista_11_Titanic.ipynb](https://github.com/LuanCarrieiros/IA/blob/main/Lista11/Lista_11_Titanic.ipynb)**.
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/LuanCarrieiros/IA.git](https://github.com/LuanCarrieiros/IA.git)
    ```
...
3.  **Execute o Notebook:**
    Abra o arquivo **[Lista_11_Titanic.ipynb](https://github.com/LuanCarrieiros/IA/blob/main/Lista11/Lista_11_Titanic.ipynb)** em um ambiente como Jupyter Lab, Jupyter Notebook ou VS Code e execute as células na ordem.